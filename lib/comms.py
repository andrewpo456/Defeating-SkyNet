...
class StealthConn(object):
    ...
    def initiate_session(self):
        ...
        self.cipher = XOR.new(shared_hash[:4]) #TODO: Replace with AES cipher method
        
        # cipher = AES.new(their_public_key,         
    ...
    def encrypt(self, data):
        ...
        # cipher = AES.new(their_public_key, MODE, iv)
    
    def decrypt(self, data):
        print("Decrypting...") #Remove when function implemented
        ## TODO - Implement block cipher
        # cipher = AES.new(our_private_key, MODE, iv)
